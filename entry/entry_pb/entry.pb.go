...
type Attribute struct {
	...
	Mine     string `protobuf:"bytes,3,opt,name=mine,proto3" json:"mine,omitempty"`
...
func (x *Attribute) GetTime() int64 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *Attribute) GetMode() uint32 {
	if x != nil {
		return x.Mode
	}
	return 0
...
func (x *Attribute) GetMine() string {
	if x != nil {
		return x.Mine
	}
	return ""
...
func (x *Attribute) GetTtlSec() uint64 {
	if x != nil {
		return x.TtlSec
	}
	return 0
...
func (x *Attribute) GetFileSize() uint64 {
	if x != nil {
		return x.FileSize
	}
	return 0
...
func (x *Entry) GetAttribute() *Attribute {
	if x != nil {
		return x.Attribute
	}
	return nil
...
var file_entry_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x79, 0x12, 0x31, 0x0a, 0x09, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x5f, 0x70, 0x62,
	0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x09, 0x61, 0x74, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x65, 0x6e, 0x74, 0x72, 0x79,
...
var file_entry_proto_goTypes = []interface{}{
	(*Attribute)(nil), // 0: entry_pb.Attribute
	(*Entry)(nil),     // 1: entry_pb.Entry
}
var file_entry_proto_depIdxs = []int32{
	0, // 0: entry_pb.Entry.attribute:type_name -> entry_pb.Attribute
